...
require (
	...
	github.com/konflux-ci/release-service c26de6b7ce6e
...
require (
	...
	google.golang.org/genproto/googleapis/api 42d3e9bedb6d // indirect
	google.golang.org/genproto/googleapis/rpc 42d3e9bedb6d // indirect
